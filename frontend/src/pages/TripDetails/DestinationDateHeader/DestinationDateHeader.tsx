...
export default function DestinationDateHeader({
  ...
  return (
    <div className="px-4 h-16 rounded-xl bg-zinc-900 shadow-[var(--shadow)] flex items-center justify-between xs:max-sm:flex-col xs:max-sm:items-start xs:max-sm:h-44 xs:max-sm:py-4">
      <div className="flex items-center gap-2">
        <MapPin className="size-5 text-zinc-400" />
        <span className="text-lg text-zinc-100">{trip.destination}</span>
      </div>
      <div className="flex items-center gap-5 xs:max-sm:flex-col xs:max-sm:items-start">
        <div className="flex items-center gap-2">
